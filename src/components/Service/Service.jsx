    ...
    <div className="py-20 px-6">
      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-6">
        {quizzes.map((quiz, index) => (
          <div
            key={index}
            className={`border border-white p-6 rounded-lg bg-transparent hover:bg-teal-400/10 transition-all duration-300 shadow-lg flex flex-col justify-center items-center ${quiz.className}`}
          >
